...
<body>
	<div class="container">
		<div class="starter-template" style="margin: 1em">
			<form method="POST" action="/resource/assignment/submission" enctype="multipart/form-data">
				<div class="form-group">
					<label id="label" for="file">Upload file for submitting your assignment</label> 
