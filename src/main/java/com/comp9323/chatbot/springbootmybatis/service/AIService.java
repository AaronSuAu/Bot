...
public class AIService {
	...
	/**
	   ...
	   */
	  public final AIResponse request(AIRequest aiRequest, AIServiceContext serviceContext)
	   ...
	   * @throws AIServiceException Thrown on server access error
	   */
	  public final AIResponse request(String query, AIServiceContext serviceContext)
	      throws AIServiceException {
	   ...
	   * @throws AIServiceException Thrown on server access error
	   */
	  public final AIResponse request(AIRequest aiRequest, HttpSession session)
	      throws AIServiceException {
	   ...
	   * @throws AIServiceException Thrown on server access error
	   */
	  public final AIResponse request(AIRequest aiRequest, String sessionId)
	      throws AIServiceException {
	    return request(aiRequest,
